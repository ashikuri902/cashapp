      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          ...
          <div className="lg:col-span-1">
            <a href="#" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-['Space_Grotesk'] font-bold text-white text-lg">
                Gift Access <span className="text-[#00FF85]">Rewards</span>
              </span>
            </a>
        ...
        <div className="pt-7 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-xs text-[#A0A0A0]">
            © {new Date().getFullYear()} Gift Access Rewards. All rights reserved.
          </div>
        ...
        <div className="mt-7 p-4 md:p-5 rounded-2xl bg-white/[0.02] border border-white/5">
          <p className="text-[11px] md:text-xs text-[#A0A0A0] leading-relaxed text-center max-w-3xl mx-auto">
            ...
            Gift Access Rewards is an independent rewards access platform. Cash App is a trademark of Block, Inc. This site is not affiliated with, endorsed by, or sponsored by Block, Inc. Reward availability, terms, and conditions are subject to the third-party offer provider.
          </p>
        </div>
      </div>
    </footer>
